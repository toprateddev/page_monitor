    ...
    $("#new_sound_create").click(function() {
        ...
        if (e && a) {
            ...
            g.addEventListener("canplaythrough", function() {
                var d = getSetting(SETTINGS.custom_sounds) || [];
                d.push({
                    name: a,
                    url: e
                });
                setSetting(SETTINGS.custom_sounds, d);
...
function addPageToTable(a) {
    var b = $("#templates .page_record").clone(),
        ...
        c = !1,
        d = a.name || chrome.i18n.getMessage("untitled", a.url);
